document.getElementById('sidebar-toggle').addEventListener('click', function() {
    ...
    if (!isOpen) {
        ...
        button.innerHTML = "<i class='fa fa-chevron-left icon-sidebar' aria-hidden='true'></i>";
        sidebar.classList.add('open');
    } else {
        sidebar.style.left = '-16em';
        button.style.transition = 'left 0.3s ease-in-out';
        button.style.left = '1rem';
        button.innerHTML = "<i class='fa fa-chevron-right icon-sidebar' aria-hidden='true'></i>";
